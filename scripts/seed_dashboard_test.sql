...
INSERT INTO takes (
    ...
    (1, 301, '2023-1', 93, true),
    (1, 302, '2023-1', 93, true),
    (1, 303, '2023-2', 93, true),
    (1, 304, '2023-2', 93, true),
    (1, 305, '2024-1', 93, true),
    (1, 306, '2023-1', 93, true),
    (1, 307, '2023-2', 93, true),
    (1, 308, '2024-1', 93, true),
    (1, 309, '2024-1', 93, true),
    (1, 310, '2024-2', 93, true),
    (1, 311, '2024-2', 93, true),
    (1, 312, '2025-1', 93, true),
    (1, 313, '2025-1', 93, true),
    (1, 314, '2025-1', 94, true),
    (1, 315, '2025-1', 94, true),
    (1, 316, '2025-2', 94, true),
    (1, 317, '2025-2', 94, true),
    (1, 318, '2025-2', 94, true),
    (1, 319, '2024-1', 94, true),
    (1, 320, '2024-1', 94, true),
    (1, 321, '2024-2', 94, true),
    (1, 322, '2024-2', 94, true),
    (1, 323, '2025-1', 94, true),
    (1, 324, '2025-1', 94, true),
    (1, 325, '2025-2', 94, true),
    (1, 326, '2025-2', 94, true),
    -- ── 李小八(student 3,修課中)── 故意留 planned / missing 方便測詳細頁
    -- done(修過):301,302,303,306,307,308,314,317
    (3, 301, '2024-1', 90, true),
    (3, 302, '2024-1', 88, true),
    (3, 303, '2024-2', 85, true),
    (3, 306, '2024-1', 92, true),
    (3, 307, '2024-2', 90, true),
    (3, 308, '2025-1', 87, true),
    (3, 314, '2025-1', 91, true),
    (3, 317, '2025-1', 89, true),
    -- planned(is_passed=false,grade 留 NULL):304,309,315
    (3, 304, '2024-2', NULL, false),
    (3, 309, '2025-1', NULL, false),
    (3, 315, '2025-2', NULL, false);
